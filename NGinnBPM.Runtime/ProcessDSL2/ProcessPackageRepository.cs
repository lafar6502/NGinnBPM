...
namespace NGinnBPM.Runtime.ProcessDSL2
{
    public class ProcessPackageRepository : IProcessPackageRepo
    {
        ...
        private Dictionary<string, BooProcessPackage> _packageCache = new Dictionary<string, BooProcessPackage>();
        ...
        {
            _packageCache = new Dictionary<string, BooProcessPackage>();
        }
